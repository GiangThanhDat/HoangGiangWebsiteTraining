(function (app) {
    ...
    app.controller('ThuTienController', ThuTienController);

    ThuTienController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter', 'commonService'];
    function ThuTienController($scope, apiService, notificationService, $ngBootbox, $filter, commonService) {
        ...
        $scope.themdong = function (ma,ten) {
            ...
            $scope.ChiTietThu[$scope.clickss - 1] = { MaPhieuThu: $scope.PhieuThu.MaPhieuThu, MaKhachHang: ma, TenKhachHang: ten}
        ...
        $scope.luutaikhoanvaochitietthu = function (ma, ten, i, diengiai, taikhoanno, taikhoanco, sotien, tknh, mucthichi, donvi, congtrinh, hopdongban, mathongke) {
            $scope.ChiTietThu[i] = { MaPhieuThu: $scope.PhieuThu.MaPhieuThu, SoTien: sotien, DienGiai: diengiai, SoTaiKhoanCo: taikhoanco, SoTaiKhoanNo: taikhoanno, MaKhachHang: ma, TenKhachHang: ten, TaiKhoanNganHang: tknh, MucThuChi: mucthichi, DonVi: donvi, CongTrinh: congtrinh, HopDongBan: hopdongban, MaThongKe: mathongke }
        }
