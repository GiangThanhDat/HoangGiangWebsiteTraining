(function (app) {
    ...
    app.controller('quanLyVangMatController', quanLyVangMatController);

    quanLyVangMatController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter', 'dateFilter'];
    function quanLyVangMatController($scope, apiService, notificationService, $ngBootbox, $filter, dateFilter) {
        ...
        $scope.getbyngay = function () {
            ...
            apiService.get('/api/quanlyvangmat/xemtheongay', config, function (result) {
        ...
        $scope.getbymsnv = function () {
            ...
            apiService.get('/api/quanlyvangmat/xemtheomsnv', config, function (result) {
        ...
        $scope.getbytennv = function () {
            ...
            apiService.get('/api/quanlyvangmat/xemtheotennv', config, function (result) {
        ...
        $scope.getbytuan = function () {
            ...
            apiService.get('/api/quanlyvangmat/getall', null, function (result) {


                angular.forEach(result.data, function (item) {
                    item.NgayVangMat = new Date(item.NgayVangMat);
                    if (ngayhientai >= item.NgayVangMat && item.NgayVangMat >= thu2()) {
        ...
        $scope.getbythang = function () {
            ...
            apiService.get('/api/quanlyvangmat/getall', null, function (result) {
                ...
                angular.forEach(result.data, function (item) {
                    item.NgayVangMat = new Date(item.NgayVangMat);
                    if (newcuoithang >= item.NgayVangMat && item.NgayVangMat >= $scope.thangxem) {
