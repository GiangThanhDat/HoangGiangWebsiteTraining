(function (app) {
    ...
    app.controller('ThongKeTraLaiHangMuaController', ThongKeTraLaiHangMuaController);

    ThongKeTraLaiHangMuaController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter', 'commonService', '$http'];
    function ThongKeTraLaiHangMuaController($scope, apiService, notificationService, $ngBootbox, $filter, commonService, $http) {
        $scope.gridOptions = {
        ...
        $scope.getfromtoday = function (ngaydau, ngaycuoi) {
            ...
            apiService.get('/api/tralaihangmua/gettralaihangmua', config, function (result) {

                $scope.gettralaihangmua = result.data;
        ...
        $scope.gridOptions.columnDefs = [
            { name: 'xemchitiet', width: 200, cellTemplate: '<span  ng-click="grid.appScope.xemTLHM(row)">Xem chi tiết</span>', headerCellClass: 'text-center'},
            ...
            { name: 'MaTraLaiHangMua', width: 200, pinnedRight: false, headerCellClass: 'text-center' },
        ...
        $scope.xemTLHM = function (row) {
            var index = row.entity.MaTraLaiHangMua;
            $scope.singer = {}
            $('.bs-example-modal-lg').modal('show');
            angular.forEach($scope.Data, function (i) {

                if (i.MaTraLaiHangMua == index) {
                    $scope.singer = i;
                }
            ...
            apiService.get('/api/chitiettralaihangmua/getchitiettralaihangmua', config, function (result) {
