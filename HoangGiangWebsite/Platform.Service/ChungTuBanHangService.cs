...
namespace Platform.Service
{
    public interface IChungTuBanHangService
    {
        ...
        IQueryable<getchungtubanhang> getctbh(DateTime ngaydau, DateTime ngaycuoi, string macoso, bool dathaydoi);
    ...
    public class ChungTuBanHangService : IChungTuBanHangService
    {
        ...
        public IQueryable<getchungtubanhang> getctbh(DateTime ngaydau, DateTime ngaycuoi, string macoso, bool dathaydoi)
        {
