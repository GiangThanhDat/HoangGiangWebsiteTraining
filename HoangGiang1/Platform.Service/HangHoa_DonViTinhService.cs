...
namespace Platform.Service
{
    public interface IHangHoa_DonViTinhService
    {
        ...
        HangHoa_DonViTinh GetHangHoaDonViTinh(int MaDonVi, string MaHang);
    ...
    public class HangHoa_DonViTinhService : IHangHoa_DonViTinhService
    {
        ...
        public HangHoa_DonViTinh GetHangHoaDonViTinh(int MaDonVi, string MaHang)
        {
            return _hangHoa_DonViTinhRepository.GetSingleByCondition(x => x.MaDonViTinh == MaDonVi && x.MaHang == MaHang);
        }
    }
}
