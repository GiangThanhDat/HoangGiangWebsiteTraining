...
namespace Platform.Service
{
    public interface IPhieuNhapKhoService
    {
        ...
        IQueryable<getphieunhapxuatkho> getthongketimeline(string mapnk);
    ...
    public class PhieuNhapKhoService : IPhieuNhapKhoService
    {
        ...
        public IQueryable<getphieunhapxuatkho> getthongketimeline(string mapnk)
        {
            return _phieuNhapKhoRepository.getthongketimeline(mapnk);
        }
    }
}
