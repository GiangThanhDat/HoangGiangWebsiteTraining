(function (app) {
    ...
    app.controller('ThongKeChuyenKhoController', ThongKeChuyenKhoController);

    ThongKeChuyenKhoController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter', 'commonService', '$http'];
    function ThongKeChuyenKhoController($scope, apiService, notificationService, $ngBootbox, $filter, commonService, $http) {
        $scope.gridOptions = {
        ...
        $scope.gridOptions.columnDefs = [
            { name: 'xemchitiet', width: 200, cellTemplate: '<span  ng-click="grid.appScope.xemChuyenKho(row)">Xem chi tiết</span>', headerCellClass: 'text-center' },
            ...
            { name: 'TongTien', width: 200, headerCellClass: 'text-center'},
            { name: 'nguoigiaonhan', width: 200, headerCellClass: 'text-center' },
            { name: 'TenkhacHhang', width: 200, headerCellClass: 'text-center' },
            { name: 'DaLap', width: 200, headerCellClass: 'text-center'},
            { name: 'LyDo', width: 200, headerCellClass: 'text-center'},
        ...
        $scope.gridOptions.columnDefs[6].displayName = 'Người vận chuyển '
        $scope.gridOptions.columnDefs[7].displayName = 'Đại lý'
        $scope.gridOptions.columnDefs[8].displayName = 'Ngày ghi sổ kho'
        $scope.gridOptions.columnDefs[9].displayName = 'Lý do'

        $scope.xemChuyenKho = function (row) {
