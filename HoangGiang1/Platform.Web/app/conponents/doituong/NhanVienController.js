(function (app) {
    ...
    app.controller('NhanVienController', NhanVienController);

    NhanVienController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter', 'commonService', '$http', 'i18nService'];
    function NhanVienController($scope, apiService, notificationService, $ngBootbox, $filter, commonService, $http, i18nService) {
        $scope.msnv = "";
    ...
    /*------------------* */
        ...
        $scope.getAllListNhanvien = function () {
            ...
            apiService.get('/api/nhanvien/getall', null, function (result) {
                ...
                angular.forEach($scope.listNhanvien, function (a) {
                    angular.forEach($scope.AllChucVu, function (b) {
                        if (a.MaChucVu == b.MaChucVu) {
                            a.TenChucVu = b.TenChucVu
                ...
                angular.forEach($scope.listNhanvien, function (a) {
                    angular.forEach($scope.AllCoSo, function (b) {
                        if (a.MaCoSo == b.MaCoSo) {
                            a.TenCoSo = b.TenCoSo
