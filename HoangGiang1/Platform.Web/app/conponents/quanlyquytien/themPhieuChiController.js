(function (app) {
    ...
    app.controller('themPhieuChiController', themPhieuChiController);

    themPhieuChiController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter','commonService'];
    function themPhieuChiController($scope, apiService, notificationService, $ngBootbox, $filter, commonService) {
        ...
        $scope.LuuPhieuThu = function () {
            ...
            $scope.PhieuThu.TongTienDichVu = total;
