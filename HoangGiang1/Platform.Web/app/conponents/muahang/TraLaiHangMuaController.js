(function (app) {
    ...
    app.controller('TraLaiHangMuaController', TraLaiHangMuaController);

    TraLaiHangMuaController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter', 'commonService','$http'];
    function TraLaiHangMuaController($scope, apiService, notificationService, $ngBootbox, $filter, commonService, $http) {
        ...
        $scope.themdong = function (ma, ten) {
            ...
            $scope.ChiTietThu[$scope.clickss - 1] = { MaTraLaiHangMua: $scope.PhieuThu.MaTraLaiHangMua, SoLuong: 0,GiaTriNhapKho:0}
        ...
        $scope.checktrung = function (mahang, item, i, km, sl, vat, ck, ) {
            ...
            if (a == -1) {
                ...
                $scope.ChiTietThu[i] = { MaHang: mahang, MaTraLaiHangMua: $scope.PhieuThu.MaTraLaiHangMua, SoLuong: sl, ThanhTien: TTTT, DonGia: km, TienChietKhau: 0, TienThueGTGT: thanhtien, GiaTriNhapKho: 0 }
            }
            else {
                var index = $scope.solanlap.indexOf(item);
                ...
                $scope.ChiTietThu[a] = { MaHang: mahang, MaTraLaiHangMua: $scope.PhieuThu.MaTraLaiHangMua, SoLuong: sl, ThanhTien: TTTT, DonGia: km, TienChietKhau: 0, TienThueGTGT: thanhtien, Kho: Kho, TKKho: TKKho, TKCongNo: TKCongNo, DienGiaiThue: DienGiaiThue, TKThueGTGT: TKThueGTGT, NhomHHDVMuaVao: NhomHHDVMuaVao, SoLo: SoLo, SoCTMuaHang: SoCTMuaHang, SoHDMuaHang: SoHDMuaHang, NgayHDMuaHang: NgayHDMuaHang, MaHopDongMua: MaHopDongMua, MaThongKe: MaThongKe}
