(function (app) {
    ...
    app.controller('ChungTuMuaHangController', ChungTuMuaHangController);

    ChungTuMuaHangController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter', 'commonService','$http'];
    function ChungTuMuaHangController($scope, apiService, notificationService, $ngBootbox, $filter, commonService, $http) {
