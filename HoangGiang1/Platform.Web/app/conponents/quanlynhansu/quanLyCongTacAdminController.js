(function (app) {
    ...
    app.controller('quanLyCongTacAdminController', quanLyCongTacAdminController);

    quanLyCongTacAdminController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter', 'dateFilter'];
    function quanLyCongTacAdminController($scope, apiService, notificationService, $ngBootbox, $filter, dateFilter) {
        ...
        $scope.getbyngay = function () {
            ...
            apiService.get('/api/quanlycongtac/xemtheongay', config, function (result) {
        ...
        $scope.getbymsnv = function () {
            ...
            apiService.get('/api/quanlycongtac/xemtheomsnv', config, function (result) {
        ...
        $scope.getbytennv = function () {
            ...
            apiService.get('/api/quanlycongtac/xemtheotennv', config, function (result) {
        ...
        $scope.getbytuan = function () {
            ...
            apiService.get('/api/quanlycongtac/getall', null, function (result) {
